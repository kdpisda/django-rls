...
class TestRLSDatabaseSchemaEditor(TestCase):
    ...
    def test_create_policy_with_operation(self):
        ...
        policy = UserPolicy(
            "test_policy", user_field="owner", operation="SELECT", permissive=False
        )
    ...
    def test_alter_policy(self):
        ...
        # Mock doesn't have get_compiled_sql, so delete it to force using get_using_expression
        del policy.get_compiled_sql
